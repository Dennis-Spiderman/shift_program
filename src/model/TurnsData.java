...
public class TurnsData {
	...
	private static final int SKIP_TURNS_LIMIT = 3;
	...
	public static String showActual() {
		if(actual == null) {
			...
			return "Todavia no se ha entregado ningun turno.";
		}
	...
	public static boolean nextTurn() {		
		...
		actual.addSkiped();
			...
			if (actual.getSkiped() == SKIP_TURNS_LIMIT) {
	...
	private static void printTurns(Turn current) {
		...
		if(current == null) {
			...
			System.out.println("Todavia no se han entregado turnos.");
